...
<div class="login-container">
    <h2>Edit Profile</h2>
    <form action="/customer/updateDetails" method="POST" onsubmit="return validateForm()">
        <div class="input-group">
            <label for="firstName">First Name</label>
            <input type="text" id="firstName" name="firstName" value="<%= userDetails.getFirstName() %>">
            <b><span id="firstName-error" style="color:red;"></span></b>    
        </div>
        <div class="input-group">
            <label for="lastName">Last Name</label>
            <input type="text" id="lastName" name="lastName" value="<%= userDetails.getLastName() %>">
        ...
        <div class="input-group">
            ...
            <input type="date" id="dateOfBirth" name="dateOfBirth" value="<%= userDetails.getDateOfBirth() %>">
            <b><span id="dob-error" style="color:red;"></span></b>
        </div>
        <div class="input-group">
            <label for="address">Address</label>
            <input type="text" id="address" name="address" value="<%= userDetails.getAddress() %>">
