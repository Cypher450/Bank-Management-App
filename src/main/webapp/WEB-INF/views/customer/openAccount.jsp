...
<body>
    ...
    <div class="account-container">
        ...
        <form action="openAccountSuccess" Method="POST"  enctype="multipart/form-data">
            <div class="form-group">
                <label for="balance">Initial Deposit (Minimum 1000):</label>
                <input type="number" id="balance" name="balance" min="1000" required>
            </div>

            <div class="form-group">
                <label for="openedDate">Date of Account Opening:</label>
                <input type="date" id="openedDate" name="openedDate" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="accountTypeId" name="accountTypeId" required>
